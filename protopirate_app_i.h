...
#define CONFIG_PLUGIN_PATH     APP_DATA_PATH("plugins/pp_config.fal")
#define SAVED_INFO_PLUGIN_PATH APP_DATA_PATH("plugins/pp_saved_info.fal")
#define ABOUT_PLUGIN_PATH      APP_DATA_PATH("plugins/pp_about.fal")
